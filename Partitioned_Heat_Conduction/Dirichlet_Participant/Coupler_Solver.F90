...
SUBROUTINE CouplerSolver( Model,Solver,dt,TransientSimulation )
    ...
    IF (bool.EQ.1) THEN
      ...
      CALL precicef_write_bsdata(fluxID, vertexSize, vertexIDs, flux);
    ...
    !   CALL precicef_read_bsdata(temperatureID, vertexSize, vertexIDs, temperature);
    ...
    ! CALL precicef_write_bvdata(temperatureID, vertexSize, vertexIDs, temperature);
    ! time_step = time_step + dt
    ! CALL precicef_advance(dt)
